...
let inner = '<div class="add_classes_div "><label for="search_class">Add class</label><input name="prg_search_class" id="search_class" type="text" class="add_std_inp" onkeyup="displayAvailableClasses(this)"><div class="class_answ settings_scrBar2"><span class="class_answ_msg">Search for a class not listed above</span></div></div>';
